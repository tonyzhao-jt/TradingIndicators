...
# Memory-optimized training configuration for 39GB GPU
# Using reduced batch sizes and aggressive memory optimizations
# Note: This config is optimized for single GPU with limited memory
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen7b_instruct_lowmem' \
